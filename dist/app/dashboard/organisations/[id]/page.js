...
export default function OrganisationForm({ params }) {
    ...
    return (<div className="p-6 max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="form-control">
          ...
          <input type="text" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} className="input input-bordered" required/>
        </div>
        ...
        <div className="form-control">
          ...
          <input type="text" value={form.address} onChange={(e) => setForm({ ...form, address: e.target.value })} className="input input-bordered" required/>
        </div>
